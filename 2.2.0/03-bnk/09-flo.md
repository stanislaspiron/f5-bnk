...
# CNE Manifest object to prevent download from Internet
...
kind: CNEManifest
metadata:
  name: bigip-k8s-manifest-${f5_bnk_version}
spec: $(yq -o=j -I0 '{ "images": .releases.0.docker_images  ,  "version": .releases.0.version}'  ${manifest_file})
EOF
```
